...
struct ChampagneTheme: ThemeProtocol {
	...
	var backgroundColor: UIColor = UIColor(red: 0.969, green: 0.906, blue: 0.598, alpha: 1.0)
	var textColor: UIColor = .purple
	var barStyle: UIBarStyle = .default
	var secondaryBackground: UIColor = UIColor(red: 1, green: 0.930, blue: 0.640, alpha: 1.0)
}
