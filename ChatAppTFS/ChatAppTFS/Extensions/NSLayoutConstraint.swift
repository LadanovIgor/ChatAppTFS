...
extension NSLayoutConstraint {
	...
	static func constraints(withNewVisualFormat vf: String, metrics: [String: Any]?, views: [String: Any]) -> [NSLayoutConstraint] {
		...
		case 2: return NSLayoutConstraint.constraints(withVisualFormat: "\(separatedArray[0])", options: [], metrics: metrics, views: views) + NSLayoutConstraint.constraints(withVisualFormat: "\(separatedArray[1])", options: [], metrics: metrics, views: views)
